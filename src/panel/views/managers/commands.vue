                ...
                >
                  ...
                  >
                    ...
                    <textarea-with-tags
                      ...
                      :filters="['sender', 'source', 'param', 'haveParam', 'is.moderator', 'is.subscriber', 'is.vip', 'is.follower', 'is.broadcaster', 'is.bot', 'is.owner', 'rank', 'game', 'language', 'title', 'views', 'followers', 'hosts', 'subscribers', 'isBotSubscriber']"
                      :state="true"
      ...
      >
        ...
        >
          <template #cell(command)="data">
            <b-badge
              :variant="[ data.item.enabled ? 'success' : 'danger' ]"
              class="command"
            >
              {{ data.item.command }}
            </b-badge>
          ...
          <template #cell(response)="data">
            ...
            <template v-for="(r, i) of orderBy(data.item.responses, 'order', 'asc')">
              <div
                ...
                style="margin: 0; font-size: 11px; font-weight: 400; text-transform: uppercase; letter-spacing: 1px;padding: 0 0 8px 0;"
              >
              ...
              <text-with-tags
                :key="100 + i"
                :value="r.response"
                style="display: inline-block; font-weight: 300;font-style: italic;"
              />
            </template>
          </template>
